...
#define CONFIG_MDNS_HOST_NAME "_Tatow"
#define CONFIG_MDNS_INSTANCE "_Camera_Stream"
...
static void initialise_mdns(void)
{
    ...
    ESP_ERROR_CHECK(mdns_service_add("ESP32-WebServer", "_http", "_udp", 80, serviceTxtData,
